...
base_dir <- Sys.getenv("DBSCAN_BASE_DIR", unset = "/projects/bignellr/cheny35/DBSCAN_SCRIPT")
...
out_dir_name <- Sys.getenv("DBSCAN_OUT_DIR", unset = "results_full_year_2025_fread_fwrite_1t16th")
out_dir <- file.path(base_dir, out_dir_name)
